...
namespace GestionPretForm
{
    public partial class FormAdherent : Form
    {
        ...
        private void AdherentIDTextBox_Validating(object sender, CancelEventArgs e)
        {
            
        }

        private void AdherentIDTextBox_TextChanged(object sender, EventArgs e)
        {
        ...
        private void BtnValider_Click(object sender, EventArgs e)
        {
            ...
            {
                if (adherent.AdherentID == item.AdherentID)
                {
